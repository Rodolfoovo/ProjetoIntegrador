...
from .views import transacao_view, cadastrarTransacao_view, editarTransacao_view, deletarTransacao_view

urlpatterns = [
    path('', transacao_view, name="transacao_view"),
    path('salvarTransacao/', cadastrarTransacao_view, name="cadastrarTransacao_view"),
