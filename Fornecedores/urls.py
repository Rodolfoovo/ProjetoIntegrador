...
from Fornecedores.views import fornecedor_view, salvarFornecedor_view, editarFornecedor_view, deleteFornecedor_view, updateFornecedor_view, cadastrarFornecedor_view
